 ...
 */
@interface JSQMessagesViewController : UIViewController <JSQMessagesCollectionViewDataSource, UITextViewDelegate>

@property (weak, nonatomic) id<UITextViewDelegate> delegateTextView;
@property (strong, nonatomic) NSIndexPath *selectedIndexPathForMenu;
@property (assign, nonatomic) CGFloat inputToolbarDefaultHeight;
...
/**
 *  The collection view cell identifier to use for dequeuing system message collection view cells in the collectionView.
 *
