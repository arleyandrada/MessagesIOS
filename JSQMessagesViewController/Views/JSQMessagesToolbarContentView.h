...
@property (nonatomic, readwrite, assign) BOOL rightBarButtonVisible;
@property (nonatomic, readwrite, assign) BOOL leftBarButtonVisible;

@property (nonatomic, readwrite, assign) BOOL rightBarButtonEnabled;
@property (nonatomic, readwrite, assign) BOOL leftBarButtonEnabled;
