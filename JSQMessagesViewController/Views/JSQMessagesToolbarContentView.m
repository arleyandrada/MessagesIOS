...
{
    //ARLEY WAS HERE...
    NSString *className = NSStringFromClass([JSQMessagesToolbarContentView class]);
...
- (void)setRightBarButtonVisible:(BOOL)visible
{
    if (visible) {
        ...
        if (CGRectEqualToRect(self.rightBarButtonItem.frame, CGRectZero)) {
            self.rightBarButtonItem.frame = self.rightBarButtonContainerView.bounds;
        }

        self.rightBarButtonContainerView.hidden = NO;
        self.rightHorizontalSpacingConstraint.constant = kJSQMessagesToolbarContentViewHorizontalSpacingDefault;
        self.rightBarButtonItemWidth = CGRectGetWidth(self.rightBarButtonItem.frame);
...
- (void)setLeftBarButtonVisible:(BOOL)visible
{
    if (visible) {
        ...
        if (CGRectEqualToRect(self.leftBarButtonItem.frame, CGRectZero)) {
            self.leftBarButtonItem.frame = self.leftBarButtonContainerView.bounds;
        }
        
        self.leftBarButtonContainerView.hidden = NO;
        self.leftHorizontalSpacingConstraint.constant = kJSQMessagesToolbarContentViewHorizontalSpacingDefault;
        self.leftBarButtonItemWidth = CGRectGetWidth(self.leftBarButtonItem.frame);
...
{
    self.leftBarButtonItem.enabled = enabled;
}
