...
{
    //ARLEY WAS HERE...
    NSString *className = NSStringFromClass([JSQMessagesTypingIndicatorFooterView class]);
...

{
    ...
    if (isIncoming) {
        self.bubbleImageView.image = [JSQMessagesBubbleImageFactory incomingMessageBubbleImageViewWithColor:bubbleColor kind:@"min"].image;
        ...
        self.bubbleImageView.image = [JSQMessagesBubbleImageFactory outgoingMessageBubbleImageViewWithColor:bubbleColor kind:@"min"].image;
    ...
    NSString *path = [[[NSBundle mainBundle] resourcePath]
                      stringByAppendingPathComponent:@"modules/br.com.arlsoft.messages/"];
    NSBundle *bundle = [NSBundle bundleWithPath:path];
    NSString *imageName = [bundle pathForResource:@"typing" ofType:@"png"];
    self.typingIndicatorImageView.image = [[[UIImage alloc] initWithContentsOfFile:imageName] jsq_imageMaskedWithColor:indicatorColor];
