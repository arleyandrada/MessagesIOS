...
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *messageBubbleLeftMarginConstraint;
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *messageBubbleRightMarginConstraint;
...
- (void)applyLayoutAttributes:(UICollectionViewLayoutAttributes *)layoutAttributes
{
    ...
    if ([self isKindOfClass:[JSQMessagesCollectionViewCellSystem class]]) {
        self.textView.font = customAttributes.systemMessageBubbleFont;
    }
    else {
    ...
    if ([self isKindOfClass:[JSQMessagesCollectionViewCellSystem class]]) {
        [self jsq_updateConstraint:self.messageBubbleLeftMarginConstraint
                      withConstant:customAttributes.messageBubbleLeftMargin];
        [self jsq_updateConstraint:self.messageBubbleRightMarginConstraint
                      withConstant:customAttributes.messageBubbleRightMargin];
    } else {
