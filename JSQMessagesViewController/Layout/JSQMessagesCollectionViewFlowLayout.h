...
@property (strong, nonatomic) UIFont *systemMessageBubbleFont;
...
@property (assign, nonatomic) CGFloat messageBubbleLeftMargin;
@property (assign, nonatomic) CGFloat messageBubbleRightMargin;
...
@property (assign, nonatomic) UIEdgeInsets systemMessageBubbleTextViewFrameInsets;
