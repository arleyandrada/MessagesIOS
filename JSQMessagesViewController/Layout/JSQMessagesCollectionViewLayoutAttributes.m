...
{
    NSParameterAssert(messageBubbleLeftMargin >= 0.0f);
    _messageBubbleLeftMargin = ceilf(messageBubbleLeftMargin);
}

- (void)setMessageBubbleRightMargin:(CGFloat)messageBubbleRightMargin
{
    NSParameterAssert(messageBubbleRightMargin >= 0.0f);
    _messageBubbleRightMargin = ceilf(messageBubbleRightMargin);
}
...
- (BOOL)isEqual:(id)object
{
    ...
    if (self.representedElementCategory == UICollectionElementCategoryCell) {
        ...
        if (![layoutAttributes.messageBubbleFont isEqual:self.messageBubbleFont]
            || ![layoutAttributes.systemMessageBubbleFont isEqual:self.systemMessageBubbleFont]
            ...
            || (int)layoutAttributes.messageBubbleLeftMargin != (int)self.messageBubbleLeftMargin
            || (int)layoutAttributes.messageBubbleRightMargin != (int)self.messageBubbleRightMargin
...
- (instancetype)copyWithZone:(NSZone *)zone
{
    ...
    copy.systemMessageBubbleFont = self.systemMessageBubbleFont;
    copy.messageBubbleLeftRightMargin = self.messageBubbleLeftRightMargin;
    copy.messageBubbleLeftMargin = self.messageBubbleLeftMargin;
    copy.messageBubbleRightMargin = self.messageBubbleRightMargin;
