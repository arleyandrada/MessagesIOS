...
+ (UIImage *)jsq_circularImage:(UIImage *)image withDiamter:(NSUInteger)diameter customMask:(UIImage*)customMask;
...
+ (UIImage *)avatarWithImage:(UIImage *)originalImage diameter:(NSUInteger)diameter customMask:(UIImage*)customMask
{
    NSParameterAssert(originalImage != nil);
    NSParameterAssert(diameter > 0.0f);
    
    return [JSQMessagesAvatarFactory jsq_circularImage:originalImage withDiamter:diameter customMask:customMask];
}
                        ...
                        customMask:(UIImage*)customMask
{
    ...
    return [JSQMessagesAvatarFactory jsq_circularImage:image withDiamter:diameter customMask:customMask];
}
